    ...
    return (
        <>
            ...
            <div className='cover w-full bg-red-50 relative'>
                ...
                <img className='object-cover w-full h-48 md:h-[350px] shadow-blue-700 shadow-sm' src={currentUser.coverpic} alt=" cover pic" />

                {/* <img className='object-cover w-full h-48 md:h-[350px] shadow-blue-700 shadow-sm' src="/img/cover.jpg" alt="cover" /> */}

                <div className='absolute -bottom-20 right-[33%] md:right-[46%] border-white overflow-hidden border-2 rounded-full size-36'>

                    {/* <img width={150} height={150} className='object-cover w-full h-48 md:h-[350px] shadow-blue-700 shadow-sm' src="/img/pro.jpeg" alt="cover" /> */}


                    <img className='rounded-full object-cover size-36' width={128} height={128} src={currentUser.profilepic} alt="profile pic" />
                        ...
                        <ul className='mx-5 text-lg'>
                            ...
                            {payments.map((p, i) => {
                                return <li key={i} className='my-4 flex gap-2 items-center'>
                                    <img width={33} src="gif/avatar.gif" alt="user avatar" />
                                    <span>
